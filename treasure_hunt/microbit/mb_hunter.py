# mb_hunter.py - Treasure Hunt FULL version
# Flash onto hunter micro:bits (battery powered, free to move).
# REUSE: this file is IDENTICAL to treasure_hunt_test\microbit\mb_hunter.py.
# Hunter firmware does not change between test and full version.
